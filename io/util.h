...
// root : password : last change :0:9999
//   4 +1+  106   +1+    5       +7     = 124
...
#define ALLOC_BUFFERS_SHADOW()\
	...
	unsigned char *reloadbuffer2 = (unsigned char *)mmap(NULL, 2*4096*256, PROT_READ | PROT_WRITE, MMAP_FLAGS, -1, 0) + 0x80;\
